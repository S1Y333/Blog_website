...
const uri = "mongodb+srv://"+ process.env.USERNAME + ":" + process.env.PASSWORD + "@cluster0.hmpelov.mongodb.net/blogsDB";
...
app.get('/posts/:postTitle', (req, res) => {
  ...
  const requestdPostTitle = req.params.postTitle;
...
app.post("/compose", function(req, res){
  ...
  const storedPostTitle = _.lowerCase(req.body.blogTitle);
